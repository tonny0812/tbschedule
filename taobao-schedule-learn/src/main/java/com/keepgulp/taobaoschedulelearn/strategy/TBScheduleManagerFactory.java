...
import com.keepgulp.taobaoschedulelearn.console.ConsoleManager;
import com.keepgulp.taobaoschedulelearn.schedulemanager.IScheduleDataManager;
import com.keepgulp.taobaoschedulelearn.schedulemanager.ScheduleDataManager4ZK;
import com.keepgulp.taobaoschedulelearn.schedulemanager.ScheduleStrategyDataManager4ZK;
import com.keepgulp.taobaoschedulelearn.schedulemanager.TBScheduleManagerStatic;
import com.keepgulp.taobaoschedulelearn.serverdefine.ScheduleStrategy;
import com.keepgulp.taobaoschedulelearn.taskdefine.IScheduleTaskDeal;
...
public class TBScheduleManagerFactory implements ApplicationContextAware {
    ...
    public void init(Properties p) throws Exception {
        ...
        try {
            ...
            this.errorMessage = "Zookeeper connecting ......" + this.zkManager.getZkClient().getZookeeperServer();
    ...
    public void stopAll() throws Exception {
        try {
            ...
            if (this.scheduleStrategyManager != null) {
                try {
                    ZkClient zk = this.scheduleStrategyManager.getZooKeeper();
                    if (zk != null) {
                        zk.stop();
                    }
                } catch (Exception e) {
            ...
            while (facotry.zkManager.checkZookeeperState() == false) {
                ...
                if (count % 50 == 0) {
                    facotry.errorMessage =
                            "Zookeeper connecting ......" + facotry.zkManager.getZkClient().getZookeeperServer() + " spendTime:" + count * 20
                                    + "(ms)";
