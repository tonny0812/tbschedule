...
import com.keepgulp.taobaoschedulelearn.cronexpression.CronExpression;
import com.keepgulp.taobaoschedulelearn.serverdefine.ScheduleServer;
import com.keepgulp.taobaoschedulelearn.strategy.IStrategyTask;
...
abstract class TBScheduleManager implements IStrategyTask {
    ...
    TBScheduleManager(TBScheduleManagerFactory aFactory, String baseTaskType, String ownSign,
        ...
        this.heartBeatTimer.schedule(new HeartBeatTimerTask(this), new Date(System.currentTimeMillis() + 500),
            this.taskTypeInfo.getHeartBeatRate());
        initial();
    }
